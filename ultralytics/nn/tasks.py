...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):
        ...
        if m in (
            ...
            C2mb4rep,
            C2ICFDW,
            C2CIFDW, CC2IFDW, CoorC2IFDW, CoordConvPool, C3,
            C3TR,
            C3Ghost,
            nn.ConvTranspose2d,
            DWConvTranspose2d,
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C2mb, C2mb4, C2mbS, C2mbrep, C2mb4rep, C2ICFDW, C2CIFDW, CC2IFDW, CoorC2IFDW, C3, C3TR, C3Ghost, C3x, RepC3):
